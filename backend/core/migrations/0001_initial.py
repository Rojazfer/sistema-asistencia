# Generated by Django 5.2.12 on 2026-03-09 18:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrador'), ('PROFESSOR', 'Profesor'), ('STUDENT', 'Estudiante')], default='STUDENT', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='core.professorprofile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PRESENT', 'Presente'), ('LATE', 'Tarde'), ('ABSENT', 'Ausente')], default='PRESENT', max_length=10)),
                ('registered_at', models.DateTimeField(auto_now_add=True)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attendances', to='core.course')),
                ('professor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attendances', to='core.professorprofile')),
